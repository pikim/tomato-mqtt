...
mqtt_publish -g 'RAM' -n 'usage' -s "$usage" -o '"ic":"mdi:memory","stat_cla":"measurement","ent_cat":"diagnostic","unit_of_meas":"%"'
...
mqtt_publish -g 'NVRAM' -n 'usage' -s "$nv_usage" -o '"ic":"mdi:memory","stat_cla":"measurement","ent_cat":"diagnostic","unit_of_meas":"%"'
